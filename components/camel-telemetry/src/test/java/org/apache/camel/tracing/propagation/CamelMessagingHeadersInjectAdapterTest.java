...
public class CamelMessagingHeadersInjectAdapterTest {
    ...
    public void putProperties() {
        CamelJMSHeadersSpanContextPropagationInjector adapter = new CamelJMSHeadersSpanContextPropagationInjector(map, true);
    ...
    public void propertyWithoutDashEncoding() {
        CamelJMSHeadersSpanContextPropagationInjector adapter = new CamelJMSHeadersSpanContextPropagationInjector(map, false);
        adapter.put("-key-1-", "value1");
