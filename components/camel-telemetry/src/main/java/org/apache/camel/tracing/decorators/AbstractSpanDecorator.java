...
import org.apache.camel.tracing.Span;
...
public abstract class AbstractSpanDecorator implements SpanDecorator {
    ...
    @Override
    public void beforeTracingEvent(Span span, Exchange exchang, Endpoint endpoint) {
        String name = getComponentName(endpoint);
        span.setComponent(AbstractSpanDecorator.CAMEL_COMPONENT + name);
